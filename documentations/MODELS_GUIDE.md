...
## ✅ Models Created (35 Total Models)
...
### Leave Management Models (9) 🆕

27. **LeaveType.php** - Leave type definitions
28. **LeaveGroup.php** - Employee groups for policy assignment
29. **LeavePolicy.php** - Rules for leave types within groups
30. **LeaveWorkflow.php** - Multi-level approval chain definitions
31. **LeaveWorkflowLevel.php** - Specific levels in a workflow
32. **LeaveRequest.php** - Employee leave applications
33. **LeaveApproval.php** - Individual approval steps for a request
34. **LeaveBalance.php** - Employee leave entitlement and usage tracking
35. **LeaveAdjustment.php** - Manual corrections to leave balances
...
**Relationships:** `employee()`, `leaveType()`, `approvals()`, `canceller()` (User)
**Computed Attributes:** `attachment_url`
**Casts:** `start_date` (date), `end_date` (date), `duration_days` (decimal), `applied_at` (datetime), `cancelled_at` (datetime)
...
**Total Models: 35** (Updated January 2026)
